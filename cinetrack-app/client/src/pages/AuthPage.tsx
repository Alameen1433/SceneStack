        ...
        <div className="min-h-screen bg-brand-bg flex items-center justify-center p-4 overflow-hidden">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl">
                    ...
                    {/* Error Message */}
                    {error && (
                        <div className="mb-4 p-3 bg-red-500/20 border border-red-500/50 rounded-xl text-red-400 text-sm text-center animate-shake">
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="w-full px-4 py-3 bg-black/30 border border-white/10 rounded-xl text-white placeholder-brand-text-dim focus:outline-none focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/50 transition-all"
