  ...
  return (
    <div className="relative">
      <input
        ...
        onBlur={onBlur}
        className={`w-full px-4 py-3 pr-12 bg-black/40 border rounded-lg text-white placeholder:text-brand-text-muted focus:outline-none focus:ring-1 transition-all ${
          hasError
...
export const AuthPage: React.FC = () => {
  ...
  const handleBlur = (field: "email" | "password" | "inviteCode") => {
    ...
    if (field === "inviteCode")
      setFieldErrors((prev) => ({ ...prev, inviteCode: validateInviteCode(inviteCode) }));
  };
  ...
  const handleSubmit = useCallback(
    ...
    [mode, email, password, inviteCode, login, register, clearError, validateInviteCode]
  );
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="backdrop-blur-md bg-brand-surface/80 border border-brand-primary/10 rounded-2xl p-8 shadow-2xl shadow-black/50">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-brand-text-dim mt-2 text-sm tracking-wider uppercase">
          ...
          <div className="flex bg-black/40 rounded-lg p-1 mb-6">
            <button
              ...
              className={`flex-1 py-2.5 rounded-md text-sm font-medium tracking-wide transition-all duration-300 ${
                mode === "login"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-black/40 border rounded-lg text-white placeholder:text-brand-text-muted focus:outline-none focus:ring-1 transition-all ${
              ...
              <div className="animate-slideDown space-y-3">
                ...
                <div className="bg-brand-primary/10 border border-brand-primary/20 rounded-lg p-3">
                  <p className="text-sm text-brand-primary">
                    <span className="font-medium">Want to try it out?</span> Use demo code:{" "}
                    <code className="bg-black/40 px-1.5 py-0.5 rounded font-mono text-xs">
                      DEMONOW
                    </code>
                  </p>
                </div>
