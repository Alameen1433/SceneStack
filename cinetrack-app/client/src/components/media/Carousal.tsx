        ...
        >
          ...
          <div className="mt-4 md:mt-6 flex items-center gap-3">
            ...
            <button
              ...
              className={`p-2.5 md:p-3 rounded-lg transition-all hover:scale-110 active:scale-95 ${
                isInWatchlist
            ...
            >
              {isInWatchlist ? <FiCheck className="h-5 w-5" /> : <FiPlus className="h-5 w-5" />}
            </button>
          </div>
        </div>
      </div>
          ...
          {items.map((item, index) => (
            <button
              ...
              className={`h-1.5 rounded-full transition-all ${
                currentIndex === index ? "w-6 bg-white" : "w-1.5 bg-white/40 hover:bg-white/60"
              }`}
